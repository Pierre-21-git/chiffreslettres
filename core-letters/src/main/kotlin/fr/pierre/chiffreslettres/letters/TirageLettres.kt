...
/**
 * Orchestre le tirage pas-à-pas des 9 lettres (spec §4.1) : le joueur choisit
...
object TirageLettres {
    ...
    fun consonneAutorisee(dejaTirees: List<Char>): Boolean {
        ...
        val lettresRestantes = NOMBRE_LETTRES - dejaTirees.size
    ...
    fun tirerProchaineLettre(
        ...
        val demandeValide = consonneDemandee && consonneAutorisee(dejaTirees)
