...
private val HISTORIQUE_VERSIONS = listOf(
    ...
    EntreeVersion(
        ...
        date = "2026-08-30",
        changements = listOf(
            "Trophées : Duo, Confrontation, Duel mots et Duel points ne forment plus que 3 " +
                "trophées séparés par sous-titre mais une seule progression fusionnée (\"1re " +
                "partie de duel jouée\", \"Xe partie de duel gagnée\") : une victoire dans " +
                "n'importe lequel de ces 4 modes compte pour le même trophée.",
        ),
    ),
    EntreeVersion(
        version = "1.112",
    ...
    EntreeVersion(
        ...
        date = "2026-08-29",
        changements = listOf(
            "Les plaquettes lettres (mode Lettres, défi Mots max, défi Points, Duel mots) sont " +
                "maintenant encore plus grandes que le reste du plateau.",
            "Menu principal : un séparateur a été ajouté au-dessus de \"Duel mots\", pour bien le " +
                "distinguer des parties classiques.",
        ),
    ),
    EntreeVersion(
        version = "1.104",
